...
class Student {
    ...
    public Student(String studentName, int rollNumber, int totalClassesHeld, int totalClassesAttended) {
    ...
    public double getAttendancePercentage() {
         double percentage = ((double) totalClassesAttended / totalClassesHeld * 100);
...
class StudentAttendanceSystem {
    ...
    public void displayAllAttendance() {
        ...
        for (Map.Entry<Integer, Student> entry : attendanceRecords.entrySet()) {
            ...
            System.out.println("\nClasses Held: " + student.getTotalClassesHeld());
            System.out.println("\n--------------------------");
        }
    }
    ...
    public void displayAttendance(int rollNumber) {
        ...
        System.out.println("Classes Attended: " + student.getTotalClassesAttended());
